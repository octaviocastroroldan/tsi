 ...
 * @author oct88
 */
public class HistorialAcceso extends javax.swing.JFrame {
    ...
    public HistorialAcceso(String nombre, boolean permisos) {
        this.usuario = nombre;
    ...
    public void crearTabla(){
        try{
            stm = conex.createStatement();
            ResultSet lista = stm.executeQuery("SELECT a.rutUsuario, b.nomUsuario, a.tipoAccion, a.fechaAccion FROM accessLog a, usuarios b WHERE a.rutUsuario = b.rutUsuario ORDER BY a.fechaAccion DESC");
            DefaultTableModel modelo = (DefaultTableModel)tblUsuarios.getModel();
            modelo.setRowCount(0);
            String accion;
            while(lista.next()){
                if(lista.getInt("tipoAccion") == 0){
                    accion = "Cerrado Sesión";
                }
                else{
                    accion = "Inicio Sesión";
                }
                Object data[] = {lista.getString("rutUsuario"), lista.getString("nomUsuario"), accion, lista.getString("fechaAccion")};
                modelo.addRow(data);
            }
    ...
    private void initComponents() {
        ...
        tblUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Rut Usuario", "Nombre Usuario", "Acción", "Fecha"
            }
        ));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(42, 42, 42)
                .addComponent(scrTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 625, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(scrTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
